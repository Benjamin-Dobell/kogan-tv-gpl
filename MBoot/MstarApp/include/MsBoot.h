...
#define TEMP_SECURE_BOOT 0

#if (ENABLE_MODULE_MMC == 1)
#define BOOT_COMMAND "mmc read.p 0x45000000 recovery 0x00A00000; bootm 0x45000000"
#else
#define BOOT_COMMAND "nand read.e 0x45000000 recovery 0x00A00000; bootm 0x45000000"
#endif
