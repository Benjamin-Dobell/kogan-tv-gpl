#ifndef _BOARD_MST901_H
#define _BOARD_MST901_H
...
#undef MAX_PARTITION
#define MAX_PARTITION 40   /*     存储系统软件FLASH 最大分区个数     */
...
#undef KK_SPI_SIZE
#define KK_SPI_SIZE             32*KK_SPI_SECTOR_SIZE   /*      6A80X使用的FLASH的大小为1M byte       */
#endif
