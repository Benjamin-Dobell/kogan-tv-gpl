...
#define BALL_C6_IS_GPIO     GPIO_OUT_HIGH           // 
#define BALL_B6_IS_GPIO     GPIO_OUT_LOW           // PRE_AMP
#define BALL_A6_IS_GPIO     GPIO_OUT_HIGH          // Standby Status for Dongle
...
#define BALL_K6_IS_GPIO     GPIO_IN                // EAR phone
...
#define LK_KEYPAD_CH3_LB                0x1A
#define LK_KEYPAD_CH4_UB                0x3F
#define LK_KEYPAD_CH4_LB                0x1A
...
#define USB_MBOOT_CURRENT_VERSION         "99011274/"MVERSION"/"MBUILD"(" __DATE__" - "__TIME__ ")"

#define KONKA_BOOT_CFG
#define USB_UPGRADE_USE_ENGLISH_STR  0   /// 1 english   0 chinese  
