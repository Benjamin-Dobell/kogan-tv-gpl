...
#define PADS_3D_FLAG_CONFIG         PAD_SPDIF_IN//Unknown_pad_mux
...
#define PADS_SPDIF_IN               Unknown_pad_mux//PAD_SPDIF_IN    // ready
...
#if defined (CONFIG_URSA_6M30)//only for msd6369+6M30qsc solution
#define BALL_L6_IS_GPIO     GPIO_OUT_HIGH           // Mute speaker
#define BALL_H6_IS_GPIO     GPIO_OUT_LOW           // Mute speaker
#else
...
#define BALL_E5_IS_GPIO     GPIO_IN
...
#define KEYPAD_TYPE_SEL                 KEYPAD_TYPE_CUSTMOER    // KEYPAD_TYPE_DEMO
...
#if defined (CONFIG_URSA_6M30)//only for msd6369+6M30qsc solution
#define Panel_VCC_ON()                  mdrv_gpio_set_low( BALL_L6 )   // Y9->Y10
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( BALL_L6 )  // Y9->Y10
#else
...
// LED Control
#define LED_RED_ON()                    mdrv_gpio_set_high(BALL_G9)
#define LED_RED_OFF()                   mdrv_gpio_set_low(BALL_G9)
...
#if (KEYPAD_TYPE_SEL == KEYPAD_TYPE_ORIG)   // CUSTMOER keypad
...
#elif (KEYPAD_TYPE_SEL == KEYPAD_TYPE_CUSTMOER)   // MStar normal keypad
#define ADC_KEY_1_L0_FLAG               0x1E //KEYPADKEY_POWER
#define ADC_KEY_1_L1_FLAG               0x21 //KEYPADKEY_VOLUME_MINUS
#define ADC_KEY_1_L2_FLAG               0x12 //KEYPADKEY_VOLUME_PLUS
#define ADC_KEY_1_L3_FLAG               0x20 //KEYPADKEY_CHANNEL_MINUS
#define ADC_KEY_1_L4_FLAG               0x2E //KEYPADKEY_CHANNEL_PLUS
#define ADC_KEY_1_L5_FLAG               0x30 //KEYPADKEY_MENU
#define ADC_KEY_1_L6_FLAG               0x23 //KEYPADKEY_INPUT_SOURCE
#define ADC_KEY_1_L7_FLAG               IRKEY_DUMY//RFU
...
#define USB_MBOOT_CURRENT_VERSION         MVERSION"/"MBUILD"(" __DATE__" - "__TIME__ ")"

#define KONKA_BOOT_CFG
#define USB_UPGRADE_USE_ENGLISH_STR  1   /// 1 english   0 chinese  
