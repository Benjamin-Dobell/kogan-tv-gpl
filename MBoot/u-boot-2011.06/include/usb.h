...
//#define USB_MAX_STOR_DEV 2     // fix the redefine compile error
...
int usb_init_exhub_port(int port, int ext_hub_port); /* initialize the USB Controller and only enable one external hub port */
...
#define ENABLE_SECOND_EHC
	...
	defined(CONFIG_JANUS2) || defined(CONFIG_AMBER5) || defined(CONFIG_KAISERIN) || defined(ENABLE_AMBER3) || \
	defined(ENABLE_EAGLE) || defined(ENABLE_AGATE) || defined(ENABLE_EDISON) || defined(ENABLE_EIFFEL) || \
	defined(ENABLE_NIKE)
#define ENABLE_THIRD_EHC
#endif

#if defined(CONFIG_KAISERIN) || (ENABLE_EIFFEL)
