...
inline void _chip_flush_miu_pipe(void)
{
    ...
    *(volatile unsigned int *)(0xbf203104) = 0x12;
    ...
    dwReadData = *(volatile unsigned int *)(0xbf201600);    //Dummy Read
    *(volatile unsigned int *)(0xbf203104) = ((*(volatile unsigned int *)(0xBF203104) & 0xFFF0) | 0x0002);  //mode 2:Flush Pipe Data
    dwReadData = *(volatile unsigned int *)(0xbf201600);    //Dummy Read
    *(volatile unsigned int *)(0xbf203104) = ((*(volatile unsigned int *)(0xBF203104) & 0xFFE0) | 0x0012);  //mode 2:Fire
...
void Chip_L2_cache_inv( unsigned long addr, unsigned long size)
{
    ...
    else //if(((*(volatile unsigned int *)(0xbf203100)) & BIT1) == 0)
    {
        ...
        *(volatile unsigned int *)(0xbf203104) = dwTempData;
        ...
        //Initial All Invalid
        dwTempData = *(volatile unsigned int *)(0xbf203104);
        dwTempData &= ~(0x0F);                                   //Set cache_op_mode
        *(volatile unsigned int *)(0xbf203104) = dwTempData;
        ...
        *(volatile unsigned int *)(0xbf203104) = dwTempData;
        ...
        {
            dwTempData = *(volatile unsigned int *)(0xbf203104);
            dwTempData &= _BIT(8);  //Check Status of Cache Operation Finish
...
{
#if defined(CONFIG_TITANIA8) || defined(CONFIG_TITANIA9) || defined(CONFIG_JANUS2) || defined(CONFIG_TITANIA13) || defined(CONFIG_AMBER1) || defined(CONFIG_AMBER5) || defined(CONFIG_EMERALD)
...
{
#if defined(CONFIG_TITANIA8) || defined(CONFIG_AMBER5) || defined(CONFIG_TITANIA9) || defined(CONFIG_JANUS2) || defined(CONFIG_TITANIA13) || defined(CONFIG_AMBER1) || defined(CONFIG_AMBER6) || defined(CONFIG_AMBER7) || defined(CONFIG_EMERALD)
