 ...
 */
#if defined(CONFIG_MP_DEBUG_TOOL_WATCHDOG) 
extern int Kernel_Level();
#endif /* CONFIG_MP_DEBUG_TOOL_WATCHDOG */
static void
		  ...
		  struct pt_regs *regs)
{
	...
	#if defined(CONFIG_MP_DEBUG_TOOL_WATCHDOG)	
    int debug_level= 0;
    #if CONFIG_MSTAR_KERNEL_FAULT_DO_WDT_RESET  // HW Reset after 4 sec
        debug_level=Kernel_Level();
        if(debug_level==0)
         {
