...
#ifdef MP_Android_ALARM_CLOCK_BOOTTIME_PATCH
...
#ifndef MP_Android_ALARM_CLOCK_BOOTTIME_PATCH
...
static int alarm_suspend(struct platform_device *pdev, pm_message_t state)
{
	...
	if (wakeup_queue) {
        ...
        // for now we can't get rtc time and will have wrong time.
        // in this case, here will stop mstar str.
        // so now remove it temporarily
