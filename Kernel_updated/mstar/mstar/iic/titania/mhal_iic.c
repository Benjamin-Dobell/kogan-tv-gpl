...
{
    #if (CONFIG_MSTAR_TITANIA_BD_T2_CUS03_VBRD_BOARD_DVB_1)  || \
        (CONFIG_MSTAR_TITANIA_BD_T2_CUS03_MBRD_BOARD_ATSC_1) || \
        (CONFIG_MSTAR_TITANIA_BD_T2_CUS03_MBRD_BOARD_DVB_1) || \
	...
	MHal_CHIP_REG(REG_IIC_MODE) |= BIT9;
	MHal_CHIP_REG(REG_IIC_MODE) &= ~BIT8;
#elif(CONFIG_MSTAR_TITANIA_BD_MST055A_D01A_S)
	//set all pads (except SPI) as input
	MHal_CHIP_REG(REG_IIC_MODE) &= ~BIT15;
	//iic master mode is enabled, bit 9~8 set to 2
	MHal_CHIP_REG(REG_IIC_MODE) |= BIT9;
	MHal_CHIP_REG(REG_IIC_MODE) &= ~BIT8;
#elif(CONFIG_MSTAR_TITANIA_BD_MST055B_D01A_S)
	//set all pads (except SPI) as input
	MHal_CHIP_REG(REG_IIC_MODE) &= ~BIT15;
	//iic master mode is enabled, bit 9~8 set to 1
	MHal_CHIP_REG(REG_IIC_MODE) &= ~BIT9;
	MHal_CHIP_REG(REG_IIC_MODE) |= BIT8;
#elif(CONFIG_MSTAR_TITANIA_BD_MST055C_D01A_S)
	//set all pads (except SPI) as input
	MHal_CHIP_REG(REG_IIC_MODE) &= ~BIT15;
	//iic master mode is enabled, bit 9~8 set to 2
	MHal_CHIP_REG(REG_IIC_MODE) |= BIT9;
	MHal_CHIP_REG(REG_IIC_MODE) &= ~BIT8;
#elif(CONFIG_MSTAR_TITANIA_BD_MST055E_D01A_S)
	//set all pads (except SPI) as input
	MHal_CHIP_REG(REG_IIC_MODE) &= ~BIT15;
	//iic master mode is enabled, bit 9~8 set to 2
	MHal_CHIP_REG(REG_IIC_MODE) |= BIT9;
	MHal_CHIP_REG(REG_IIC_MODE) &= ~BIT8;
#elif(CONFIG_MSTAR_TITANIA_BD_MST056C_D01A_S)
	//set all pads (except SPI) as input
	MHal_CHIP_REG(REG_IIC_MODE) &= ~BIT15;
	//iic master mode is enabled, bit 9~8 set to 1
	MHal_CHIP_REG(REG_IIC_MODE) &= ~BIT9;
	MHal_CHIP_REG(REG_IIC_MODE) |= BIT8;
#elif(CONFIG_MSTAR_TITANIA_BD_S5_CUS03_DEMO_BOARD_1		||	\
	  CONFIG_MSTAR_TITANIA_BD_S6_CUS03_DEMO_BOARD_ATSC_1	||	\
	  CONFIG_MSTAR_TITANIA_BD_S6_CUS03_DEMO_BOARD_DVB_1)
	//set all pads (except SPI) as input
	MHal_CHIP_REG(REG_IIC_MODE) &= ~BIT15;
	//iic master mode is enabled, bit 9~8 set to 2
	MHal_CHIP_REG(REG_IIC_MODE) |= BIT9;
