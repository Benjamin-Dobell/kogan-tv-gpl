...
#define GPIO8_PAD PAD_DDCR_CK
#define GPIO8_OEN 0x0f3c, BIT0
#define GPIO8_OUT 0x0f3c, BIT1
#define GPIO8_IN  0x0f3c, BIT2

#define GPIO9_PAD PAD_DDCR_DA
#define GPIO9_OEN 0x0f3a, BIT0
#define GPIO9_OUT 0x0f3a, BIT1
#define GPIO9_IN  0x0f3a, BIT2
...
#define GPIO33_PAD PAD_DDCA_CK
#define GPIO33_OEN 0x0494, BIT1
#define GPIO33_OUT 0x0494, BIT2
#define GPIO33_IN  0x0494, BIT0

#define GPIO34_PAD PAD_DDCA_DA
#define GPIO34_OEN 0x0494, BIT5
#define GPIO34_OUT 0x0494, BIT6
#define GPIO34_IN  0x0494, BIT4
...
#define GPIO76_OEN 0x102b88, BIT1
#define GPIO76_OUT 0x102b88, BIT0
#define GPIO76_IN  0x102b88, BIT2

#define GPIO77_PAD PAD_PWM1
#define GPIO77_OEN 0x102b89, BIT1
#define GPIO77_OUT 0x102b89, BIT0
#define GPIO77_IN  0x102b89, BIT2

#define GPIO78_PAD PAD_PWM2
#define GPIO78_OEN 0x102b8a, BIT1
#define GPIO78_OUT 0x102b8a, BIT0
#define GPIO78_IN  0x102b8a, BIT2

#define GPIO79_PAD PAD_PWM3
#define GPIO79_OEN 0x102b8b, BIT1
#define GPIO79_OUT 0x102b8b, BIT0
#define GPIO79_IN  0x102b8b, BIT2

#define GPIO80_PAD PAD_PWM4
#define GPIO80_OEN 0x102b8c, BIT1
#define GPIO80_OUT 0x102b8c, BIT0
#define GPIO80_IN  0x102b8c, BIT2
...
#define GPIO107_OEN 0x102bd0, BIT1
#define GPIO107_OUT 0x102bd0, BIT0
#define GPIO107_IN  0x102bd0, BIT2

#define GPIO108_PAD PAD_TS2_D1
#define GPIO108_OEN 0x102bd1, BIT1
#define GPIO108_OUT 0x102bd1, BIT0
#define GPIO108_IN  0x102bd1, BIT2

#define GPIO109_PAD PAD_TS2_D2
#define GPIO109_OEN 0x102bd2, BIT1
#define GPIO109_OUT 0x102bd2, BIT0
#define GPIO109_IN  0x102bd2, BIT2

#define GPIO110_PAD PAD_TS2_D3
#define GPIO110_OEN 0x102bd3, BIT1
#define GPIO110_OUT 0x102bd3, BIT0
#define GPIO110_IN  0x102bd3, BIT2

#define GPIO111_PAD PAD_TS2_D4
#define GPIO111_OEN 0x102bd4, BIT1
#define GPIO111_OUT 0x102bd4, BIT0
#define GPIO111_IN  0x102bd4, BIT2

#define GPIO112_PAD PAD_TS2_D5
#define GPIO112_OEN 0x102bd5, BIT1
#define GPIO112_OUT 0x102bd5, BIT0
#define GPIO112_IN  0x102bd5, BIT2

#define GPIO113_PAD PAD_TS2_D6
#define GPIO113_OEN 0x102bd6, BIT1
#define GPIO113_OUT 0x102bd6, BIT0
#define GPIO113_IN  0x102bd6, BIT2

#define GPIO114_PAD PAD_TS2_D7
#define GPIO114_OEN 0x102bd7, BIT1
#define GPIO114_OUT 0x102bd7, BIT0
#define GPIO114_IN  0x102bd7, BIT2

#define GPIO115_PAD PAD_TS2_VLD
#define GPIO115_OEN 0x102bd8, BIT1
#define GPIO115_OUT 0x102bd8, BIT0
#define GPIO115_IN  0x102bd8, BIT2

#define GPIO116_PAD PAD_TS2_SYNC
#define GPIO116_OEN 0x102bd9, BIT1
#define GPIO116_OUT 0x102bd9, BIT0
#define GPIO116_IN  0x102bd9, BIT2

#define GPIO117_PAD PAD_TS2_CLK
#define GPIO117_OEN 0x102bda, BIT1
#define GPIO117_OUT 0x102bda, BIT0
#define GPIO117_IN  0x102bda, BIT2

#define GPIO118_PAD PAD_TS_CB_D
#define GPIO118_OEN 0x102bdc, BIT1
#define GPIO118_OUT 0x102bdc, BIT0
#define GPIO118_IN  0x102bdc, BIT2

#define GPIO119_PAD PAD_TS_CB_VLD
#define GPIO119_OEN 0x102bdd, BIT1
#define GPIO119_OUT 0x102bdd, BIT0
#define GPIO119_IN  0x102bdd, BIT2

#define GPIO120_PAD PAD_TS_CB_SYNC
#define GPIO120_OEN 0x102bde, BIT1
#define GPIO120_OUT 0x102bde, BIT0
#define GPIO120_IN  0x102bde, BIT2

#define GPIO121_PAD PAD_TS_CB_CLK
#define GPIO121_OEN 0x102bdf, BIT1
#define GPIO121_OUT 0x102bdf, BIT0
#define GPIO121_IN  0x102bdf, BIT2

#define GPIO122_PAD PAD_PCM_D3
#define GPIO122_OEN 0x102b42, BIT1
#define GPIO122_OUT 0x102b42, BIT0
#define GPIO122_IN  0x102b42, BIT2

#define GPIO123_PAD PAD_PCM_D4
#define GPIO123_OEN 0x102b43, BIT1
#define GPIO123_OUT 0x102b43, BIT0
#define GPIO123_IN  0x102b43, BIT2

#define GPIO124_PAD PAD_PCM_D5
#define GPIO124_OEN 0x102b44, BIT1
#define GPIO124_OUT 0x102b44, BIT0
#define GPIO124_IN  0x102b44, BIT2

#define GPIO125_PAD PAD_PCM_D6
#define GPIO125_OEN 0x102b45, BIT1
#define GPIO125_OUT 0x102b45, BIT0
#define GPIO125_IN  0x102b45, BIT2

#define GPIO126_PAD PAD_PCM_D7
#define GPIO126_OEN 0x102b46, BIT1
#define GPIO126_OUT 0x102b46, BIT0
#define GPIO126_IN  0x102b46, BIT2

#define GPIO127_PAD PAD_PCM_CE_N
#define GPIO127_OEN 0x102b47, BIT1
#define GPIO127_OUT 0x102b47, BIT0
#define GPIO127_IN  0x102b47, BIT2
...
#define GPIO129_PAD PAD_PCM_OE_N
#define GPIO129_OEN 0x102b49, BIT1
#define GPIO129_OUT 0x102b49, BIT0
#define GPIO129_IN  0x102b49, BIT2

#define GPIO130_PAD PAD_PCM_A11
#define GPIO130_OEN 0x102b4a, BIT1
#define GPIO130_OUT 0x102b4a, BIT0
#define GPIO130_IN  0x102b4a, BIT2

#define GPIO131_PAD PAD_PCM_IORD_N
#define GPIO131_OEN 0x102b4b, BIT1
#define GPIO131_OUT 0x102b4b, BIT0
#define GPIO131_IN  0x102b4b, BIT2

#define GPIO132_PAD PAD_PCM_A9
#define GPIO132_OEN 0x102b4c, BIT1
#define GPIO132_OUT 0x102b4c, BIT0
#define GPIO132_IN  0x102b4c, BIT2

#define GPIO133_PAD PAD_PCM_IOWR_N
#define GPIO133_OEN 0x102b4d, BIT1
#define GPIO133_OUT 0x102b4d, BIT0
#define GPIO133_IN  0x102b4d, BIT2

#define GPIO134_PAD PAD_PCM_A8
#define GPIO134_OEN 0x102b4e, BIT1
#define GPIO134_OUT 0x102b4e, BIT0
#define GPIO134_IN  0x102b4e, BIT2

#define GPIO135_PAD PAD_PCM_A13
#define GPIO135_OEN 0x102b4f, BIT1
#define GPIO135_OUT 0x102b4f, BIT0
#define GPIO135_IN  0x102b4f, BIT2

#define GPIO136_PAD PAD_PCM_A14
#define GPIO136_OEN 0x102b50, BIT1
#define GPIO136_OUT 0x102b50, BIT0
#define GPIO136_IN  0x102b50, BIT2

#define GPIO137_PAD PAD_PCM_WE_N
#define GPIO137_OEN 0x102b51, BIT1
#define GPIO137_OUT 0x102b51, BIT0
#define GPIO137_IN  0x102b51, BIT2

#define GPIO138_PAD PAD_PCM_IRQA_N
#define GPIO138_OEN 0x102b52, BIT1
#define GPIO138_OUT 0x102b52, BIT0
#define GPIO138_IN  0x102b52, BIT2

#define GPIO139_PAD PAD_PCM_A12
#define GPIO139_OEN 0x102b53, BIT1
#define GPIO139_OUT 0x102b53, BIT0
#define GPIO139_IN  0x102b53, BIT2

#define GPIO140_PAD PAD_PCM_A7
#define GPIO140_OEN 0x102b54, BIT1
#define GPIO140_OUT 0x102b54, BIT0
#define GPIO140_IN  0x102b54, BIT2

#define GPIO141_PAD PAD_PCM_A6
#define GPIO141_OEN 0x102b55, BIT1
#define GPIO141_OUT 0x102b55, BIT0
#define GPIO141_IN  0x102b55, BIT2

#define GPIO142_PAD PAD_PCM_A5
#define GPIO142_OEN 0x102b56, BIT1
#define GPIO142_OUT 0x102b56, BIT0
#define GPIO142_IN  0x102b56, BIT2

#define GPIO143_PAD PAD_PCM_WAIT_N
#define GPIO143_OEN 0x102b57, BIT1
#define GPIO143_OUT 0x102b57, BIT0
#define GPIO143_IN  0x102b57, BIT2

#define GPIO144_PAD PAD_PCM_A4
#define GPIO144_OEN 0x102b58, BIT1
#define GPIO144_OUT 0x102b58, BIT0
#define GPIO144_IN  0x102b58, BIT2

#define GPIO145_PAD PAD_PCM_A3
#define GPIO145_OEN 0x102b59, BIT1
#define GPIO145_OUT 0x102b59, BIT0
#define GPIO145_IN  0x102b59, BIT2

#define GPIO146_PAD PAD_PCM_A2
#define GPIO146_OEN 0x102b5a, BIT1
#define GPIO146_OUT 0x102b5a, BIT0
#define GPIO146_IN  0x102b5a, BIT2
...
#define GPIO148_PAD PAD_PCM_A1
#define GPIO148_OEN 0x102b5c, BIT1
#define GPIO148_OUT 0x102b5c, BIT0
#define GPIO148_IN  0x102b5c, BIT2

#define GPIO149_PAD PAD_PCM_A0
#define GPIO149_OEN 0x102b5d, BIT1
#define GPIO149_OUT 0x102b5d, BIT0
#define GPIO149_IN  0x102b5d, BIT2

#define GPIO150_PAD PAD_PCM_D0
#define GPIO150_OEN 0x102b5e, BIT1
#define GPIO150_OUT 0x102b5e, BIT0
#define GPIO150_IN  0x102b5e, BIT2

#define GPIO151_PAD PAD_PCM_D1
#define GPIO151_OEN 0x102b5f, BIT1
#define GPIO151_OUT 0x102b5f, BIT0
#define GPIO151_IN  0x102b5f, BIT2

#define GPIO152_PAD PAD_PCM_D2
#define GPIO152_OEN 0x102b60, BIT1
#define GPIO152_OUT 0x102b60, BIT0
#define GPIO152_IN  0x102b60, BIT2

#define GPIO153_PAD PAD_PCM_RESET
#define GPIO153_OEN 0x102b61, BIT1
#define GPIO153_OUT 0x102b61, BIT0
#define GPIO153_IN  0x102b61, BIT2

#define GPIO154_PAD PAD_PCM_CD_N
#define GPIO154_OEN 0x102b62, BIT1
#define GPIO154_OUT 0x102b62, BIT0
#define GPIO154_IN  0x102b62, BIT2

#define GPIO155_PAD PAD_PCM2_CE_N
#define GPIO155_OEN 0x102b63, BIT1
#define GPIO155_OUT 0x102b63, BIT0
#define GPIO155_IN  0x102b63, BIT2

#define GPIO156_PAD PAD_PCM2_IRQA_N
#define GPIO156_OEN 0x102b64, BIT1
#define GPIO156_OUT 0x102b64, BIT0
#define GPIO156_IN  0x102b64, BIT2

#define GPIO157_PAD PAD_PCM2_WAIT_N
#define GPIO157_OEN 0x102b65, BIT1
#define GPIO157_OUT 0x102b65, BIT0
#define GPIO157_IN  0x102b65, BIT2

#define GPIO158_PAD PAD_PCM2_RESET
#define GPIO158_OEN 0x102b66, BIT1
#define GPIO158_OUT 0x102b66, BIT0
#define GPIO158_IN  0x102b66, BIT2

#define GPIO159_PAD PAD_PCM2_CD_N
#define GPIO159_OEN 0x102b67, BIT1
#define GPIO159_OUT 0x102b67, BIT0
#define GPIO159_IN  0x102b67, BIT2

#define GPIO160_PAD PAD_NAND_RBZ
#define GPIO160_OEN 0x102b78, BIT1
#define GPIO160_OUT 0x102b78, BIT0
#define GPIO160_IN  0x102b78, BIT2

#define GPIO161_PAD PAD_NAND_ALE
#define GPIO161_OEN 0x102b79, BIT1
#define GPIO161_OUT 0x102b79, BIT0
#define GPIO161_IN  0x102b79, BIT2

#define GPIO162_PAD PAD_NAND_WPZ
#define GPIO162_OEN 0x102b7a, BIT1
#define GPIO162_OUT 0x102b7a, BIT0
#define GPIO162_IN  0x102b7a, BIT2

#define GPIO163_PAD PAD_NAND_WEZ
#define GPIO163_OEN 0x102b7b, BIT1
#define GPIO163_OUT 0x102b7b, BIT0
#define GPIO163_IN  0x102b7b, BIT2

#define GPIO164_PAD PAD_NAND_REZ
#define GPIO164_OEN 0x102b7c, BIT1
#define GPIO164_OUT 0x102b7c, BIT0
#define GPIO164_IN  0x102b7c, BIT2

#define GPIO165_PAD PAD_NAND_CLE
#define GPIO165_OEN 0x102b7d, BIT1
#define GPIO165_OUT 0x102b7d, BIT0
#define GPIO165_IN  0x102b7d, BIT2

#define GPIO166_PAD PAD_NAND_CEZ1
#define GPIO166_OEN 0x102b7e, BIT1
#define GPIO166_OUT 0x102b7e, BIT0
#define GPIO166_IN  0x102b7e, BIT2

#define GPIO167_PAD PAD_NAND_CEZ
#define GPIO167_OEN 0x102b7f, BIT1
#define GPIO167_OUT 0x102b7f, BIT0
#define GPIO167_IN  0x102b7f, BIT2

#define GPIO168_PAD PAD_NAND_DQS
#define GPIO168_OEN 0x102b81, BIT1
#define GPIO168_OUT 0x102b81, BIT0
#define GPIO168_IN  0x102b81, BIT2

#define GPIO169_PAD PAD_EMMC_RSTN
#define GPIO169_OEN 0x102bac, BIT1
#define GPIO169_OUT 0x102bac, BIT0
#define GPIO169_IN  0x102bac, BIT2

#define GPIO170_PAD PAD_EMMC_CLK
#define GPIO170_OEN 0x102bad, BIT1
#define GPIO170_OUT 0x102bad, BIT0
#define GPIO170_IN  0x102bad, BIT2

#define GPIO171_PAD PAD_EMMC_CMD
#define GPIO171_OEN 0x102bae, BIT1
#define GPIO171_OUT 0x102bae, BIT0
#define GPIO171_IN  0x102bae, BIT2

#define GPIO172_PAD PAD_MPIF_CLK
#define GPIO172_OEN 0x102b71, BIT1
#define GPIO172_OUT 0x102b71, BIT0
#define GPIO172_IN  0x102b71, BIT2

#define GPIO173_PAD PAD_MPIF_BUSY_ERR
#define GPIO173_OEN 0x102b72, BIT1
#define GPIO173_OUT 0x102b72, BIT0
#define GPIO173_IN  0x102b72, BIT2

#define GPIO174_PAD PAD_MPIF_CS_N
#define GPIO174_OEN 0x102b73, BIT1
#define GPIO174_OUT 0x102b73, BIT0
#define GPIO174_IN  0x102b73, BIT2

#define GPIO175_PAD PAD_MPIF_D0
#define GPIO175_OEN 0x102b74, BIT1
#define GPIO175_OUT 0x102b74, BIT0
#define GPIO175_IN  0x102b74, BIT2

#define GPIO176_PAD PAD_MPIF_D1
#define GPIO176_OEN 0x102b75, BIT1
#define GPIO176_OUT 0x102b75, BIT0
#define GPIO176_IN  0x102b75, BIT2

#define GPIO177_PAD PAD_MPIF_D2
#define GPIO177_OEN 0x102b76, BIT1
#define GPIO177_OUT 0x102b76, BIT0
#define GPIO177_IN  0x102b76, BIT2

#define GPIO178_PAD PAD_MPIF_D3
#define GPIO178_OEN 0x102b77, BIT1
#define GPIO178_OUT 0x102b77, BIT0
#define GPIO178_IN  0x102b77, BIT2

#define GPIO179_PAD PAD_I2S_IN_WS
#define GPIO179_OEN 0x102b36, BIT1
#define GPIO179_OUT 0x102b36, BIT0
#define GPIO179_IN  0x102b36, BIT2

#define GPIO180_PAD PAD_I2S_IN_BCK
#define GPIO180_OEN 0x102b37, BIT1
#define GPIO180_OUT 0x102b37, BIT0
#define GPIO180_IN  0x102b37, BIT2

#define GPIO181_PAD PAD_I2S_IN_SD
#define GPIO181_OEN 0x102b38, BIT1
#define GPIO181_OUT 0x102b38, BIT0
#define GPIO181_IN  0x102b38, BIT2

#define GPIO182_PAD PAD_SPDIF_IN
#define GPIO182_OEN 0x102b39, BIT1
#define GPIO182_OUT 0x102b39, BIT0
#define GPIO182_IN  0x102b39, BIT2

#define GPIO183_PAD PAD_SPDIF_OUT
#define GPIO183_OEN 0x102b3a, BIT1
#define GPIO183_OUT 0x102b3a, BIT0
#define GPIO183_IN  0x102b3a, BIT2

#define GPIO184_PAD PAD_I2S_OUT_WS
#define GPIO184_OEN 0x102b3b, BIT1
#define GPIO184_OUT 0x102b3b, BIT0
#define GPIO184_IN  0x102b3b, BIT2

#define GPIO185_PAD PAD_I2S_OUT_MCK
#define GPIO185_OEN 0x102b3c, BIT1
#define GPIO185_OUT 0x102b3c, BIT0
#define GPIO185_IN  0x102b3c, BIT2

#define GPIO186_PAD PAD_I2S_OUT_BCK
#define GPIO186_OEN 0x102b3d, BIT1
#define GPIO186_OUT 0x102b3d, BIT0
#define GPIO186_IN  0x102b3d, BIT2

#define GPIO187_PAD PAD_I2S_OUT_SD
#define GPIO187_OEN 0x102b3e, BIT1
#define GPIO187_OUT 0x102b3e, BIT0
#define GPIO187_IN  0x102b3e, BIT2

#define GPIO188_PAD PAD_I2S_OUT_SD1
#define GPIO188_OEN 0x102b3f, BIT1
#define GPIO188_OUT 0x102b3f, BIT0
#define GPIO188_IN  0x102b3f, BIT2

#define GPIO189_PAD PAD_I2S_OUT_SD2
#define GPIO189_OEN 0x102b40, BIT1
#define GPIO189_OUT 0x102b40, BIT0
#define GPIO189_IN  0x102b40, BIT2

#define GPIO190_PAD PAD_I2S_OUT_SD3
#define GPIO190_OEN 0x102b41, BIT1
#define GPIO190_OUT 0x102b41, BIT0
#define GPIO190_IN  0x102b41, BIT2

#define GPIO191_PAD PAD_VSYNC_Like
#define GPIO191_OEN 0x102bb0, BIT1
#define GPIO191_OUT 0x102bb0, BIT0
#define GPIO191_IN  0x102bb0, BIT2

#define GPIO192_PAD PAD_SPI1_CK
#define GPIO192_OEN 0x102bb1, BIT1
#define GPIO192_OUT 0x102bb1, BIT0
#define GPIO192_IN  0x102bb1, BIT2

#define GPIO193_PAD PAD_SPI1_DI
#define GPIO193_OEN 0x102bb2, BIT1
#define GPIO193_OUT 0x102bb2, BIT0
#define GPIO193_IN  0x102bb2, BIT2

#define GPIO194_PAD PAD_SPI2_CK
#define GPIO194_OEN 0x102bb3, BIT1
#define GPIO194_OUT 0x102bb3, BIT0
#define GPIO194_IN  0x102bb3, BIT2

#define GPIO195_PAD PAD_SPI2_DI
#define GPIO195_OEN 0x102bb4, BIT1
#define GPIO195_OUT 0x102bb4, BIT0
#define GPIO195_IN  0x102bb4, BIT2
