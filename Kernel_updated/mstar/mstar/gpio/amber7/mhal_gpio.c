...
//
    ...
    __GPIO(140), __GPIO(141), __GPIO(142), __GPIO(999), __GPIO(999), //note: index 143,144
    __GPIO(145), __GPIO(999), __GPIO(999), __GPIO(999), __GPIO(149), //note: index 146,147,148
...
{
    if(gpio_table[u8IndexGPIO].r_oen==0) return;
...
{
    if(gpio_table[u8IndexGPIO].r_out==0) return;
...
{
    if((gpio_table[u8IndexGPIO].r_oen==0)||(gpio_table[u8IndexGPIO].r_out==0)) return;
    MHal_GPIO_REG(gpio_table[u8IndexGPIO].r_oen) &= (~gpio_table[u8IndexGPIO].m_oen);
    MHal_GPIO_REG(gpio_table[u8IndexGPIO].r_out) |= gpio_table[u8IndexGPIO].m_out;
}
