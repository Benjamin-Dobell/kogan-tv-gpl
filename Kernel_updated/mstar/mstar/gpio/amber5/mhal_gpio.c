...
#define GPIO109_OEN 0x102b35, BIT1
#define GPIO109_OUT 0x102b35, BIT0
#define GPIO109_IN  0x102b35, BIT2

#define GPIO110_PAD PAD_TS2_CLK
#define GPIO110_OEN 0x102b34, BIT1
#define GPIO110_OUT 0x102b34, BIT0
#define GPIO110_IN  0x102b34, BIT2
...
//
    ...
    __GPIO(180), __GPIO(181), __GPIO(182), __GPIO(183),
