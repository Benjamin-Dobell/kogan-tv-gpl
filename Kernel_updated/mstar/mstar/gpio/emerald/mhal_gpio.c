...
#define GPIO64_OEN 0x121002, BIT1
#define GPIO64_OUT 0x121000, BIT1
#define GPIO64_IN  0x121004, BIT1

#define GPIO65_PAD PAD_UART_TX2
#define GPIO65_OEN 0x121002, BIT0
#define GPIO65_OUT 0x121000, BIT0
#define GPIO65_IN  0x121004, BIT0

#define GPIO66_PAD PAD_PWM0
#define GPIO66_OEN 0x101e96, BIT0
#define GPIO66_OUT 0x101e98, BIT0
#define GPIO66_IN  0x101e94, BIT0

#define GPIO67_PAD PAD_PWM1
#define GPIO67_OEN 0x101e96, BIT1
#define GPIO67_OUT 0x101e98, BIT1
#define GPIO67_IN  0x101e94, BIT1

#define GPIO68_PAD PAD_PWM2
#define GPIO68_OEN 0x101e96, BIT2
#define GPIO68_OUT 0x101e98, BIT2
#define GPIO68_IN  0x101e94, BIT2

#define GPIO69_PAD PAD_PWM3
#define GPIO69_OEN 0x101e96, BIT3
#define GPIO69_OUT 0x101e98, BIT3
#define GPIO69_IN  0x101e94, BIT3

#define GPIO70_PAD PAD_PWM4
#define GPIO70_OEN 0x101e96, BIT4
#define GPIO70_OUT 0x101e98, BIT4
#define GPIO70_IN  0x101e94, BIT4

#define GPIO71_PAD PAD_DDCR_DA
#define GPIO71_OEN 0x101e9a, BIT0
#define GPIO71_OUT 0x101e9a, BIT2
#define GPIO71_IN  0x101e9a, BIT4

#define GPIO72_PAD PAD_DDCR_CK
#define GPIO72_OEN 0x101e9a, BIT1
#define GPIO72_OUT 0x101e9a, BIT3
#define GPIO72_IN  0x101e9a, BIT5

#define GPIO73_PAD PAD_TGPIO0
#define GPIO73_OEN 0x101e9c, BIT0
#define GPIO73_OUT 0x101e9c, BIT4
#define GPIO73_IN  0x101e9d, BIT0

#define GPIO74_PAD PAD_TGPIO1
#define GPIO74_OEN 0x101e9c, BIT1
#define GPIO74_OUT 0x101e9c, BIT5
#define GPIO74_IN  0x101e9d, BIT1

#define GPIO75_PAD PAD_TGPIO2
#define GPIO75_OEN 0x101e9c, BIT2
#define GPIO75_OUT 0x101e9c, BIT6
#define GPIO75_IN  0x101e9d, BIT2

#define GPIO76_PAD PAD_TGPIO3
#define GPIO76_OEN 0x101e9c, BIT3
#define GPIO76_OUT 0x101e9c, BIT7
#define GPIO76_IN  0x101e9d, BIT3
...
#define GPIO88_OEN 0x101e4F, BIT2
#define GPIO88_OUT 0x101e4D, BIT2
#define GPIO88_IN  0x101e4B, BIT2

#define GPIO89_PAD PAD_TS1_D1
#define GPIO89_OEN 0x101e4F, BIT1
#define GPIO89_OUT 0x101e4D, BIT1
#define GPIO89_IN  0x101e4B, BIT1

#define GPIO90_PAD PAD_TS1_D2
#define GPIO90_OEN 0x101e4F, BIT0
#define GPIO90_OUT 0x101e4D, BIT0
#define GPIO90_IN  0x101e4B, BIT0

#define GPIO91_PAD PAD_TS1_D3
#define GPIO91_OEN 0x101e4E, BIT7
#define GPIO91_OUT 0x101e4C, BIT7
#define GPIO91_IN  0x101e4A, BIT7

#define GPIO92_PAD PAD_TS1_D4
#define GPIO92_OEN 0x101e4E, BIT6
#define GPIO92_OUT 0x101e4C, BIT6
#define GPIO92_IN  0x101e4A, BIT6
...
#define GPIO94_OEN 0x101e4E, BIT4
#define GPIO94_OUT 0x101e4C, BIT4
#define GPIO94_IN  0x101e4A, BIT4

#define GPIO95_PAD PAD_TS1_D7
#define GPIO95_OEN 0x101e4E, BIT3
#define GPIO95_OUT 0x101e4C, BIT3
#define GPIO95_IN  0x101e4A, BIT3

#define GPIO96_PAD PAD_TS1_VLD
#define GPIO96_OEN 0x101e4E, BIT2
#define GPIO96_OUT 0x101e4C, BIT2
#define GPIO96_IN  0x101e4A, BIT2

#define GPIO97_PAD PAD_TS1_SYNC
#define GPIO97_OEN 0x101e4E, BIT1
#define GPIO97_OUT 0x101e4C, BIT1
#define GPIO97_IN  0x101e4A, BIT1

#define GPIO98_PAD PAD_TS1_CLK
#define GPIO98_OEN 0x101e4E, BIT0
#define GPIO98_OUT 0x101e4C, BIT0
#define GPIO98_IN  0x101e4A, BIT0
...
#define GPIO100_OEN 0x101e7e, BIT5
#define GPIO100_OUT 0x101e78, BIT5
#define GPIO100_IN  0x101e72, BIT5

#define GPIO101_PAD PAD_PCM_A5
#define GPIO101_OEN 0x101e7e, BIT4
#define GPIO101_OUT 0x101e78, BIT4
#define GPIO101_IN  0x101e72, BIT4

#define GPIO102_PAD PAD_PCM_A6
#define GPIO102_OEN 0x101e7e, BIT3
#define GPIO102_OUT 0x101e78, BIT3
#define GPIO102_IN  0x101e72, BIT3

#define GPIO103_PAD PAD_PCM_A7
#define GPIO103_OEN 0x101e7e, BIT2
#define GPIO103_OUT 0x101e78, BIT2
#define GPIO103_IN  0x101e72, BIT2

#define GPIO104_PAD PAD_PCM_A12
#define GPIO104_OEN 0x101e7e, BIT1
#define GPIO104_OUT 0x101e78, BIT1
#define GPIO104_IN  0x101e72, BIT1

#define GPIO105_PAD PAD_PCM_IRQA_N
#define GPIO105_OEN 0x101e7e, BIT0
#define GPIO105_OUT 0x101e78, BIT0
#define GPIO105_IN  0x101e72, BIT0
...
#define GPIO107_OEN 0x101e7d, BIT5
#define GPIO107_OUT 0x101e77, BIT5
#define GPIO107_IN  0x101e71, BIT5

#define GPIO108_PAD PAD_PCM_A8
#define GPIO108_OEN 0x101e7d, BIT4
#define GPIO108_OUT 0x101e77, BIT4
#define GPIO108_IN  0x101e71, BIT4

#define GPIO109_PAD PAD_PCM_IOWR_N
#define GPIO109_OEN 0x101e7d, BIT3
#define GPIO109_OUT 0x101e77, BIT3
#define GPIO109_IN  0x101e71, BIT3

#define GPIO110_PAD PAD_PCM_A9
#define GPIO110_OEN 0x101e7d, BIT2
#define GPIO110_OUT 0x101e77, BIT2
#define GPIO110_IN  0x101e71, BIT2
...
#define GPIO112_OEN 0x101e7d, BIT0
#define GPIO112_OUT 0x101e77, BIT0
#define GPIO112_IN  0x101e71, BIT0

#define GPIO113_PAD PAD_PCM_OE_N
#define GPIO113_OEN 0x101e7c, BIT7
#define GPIO113_OUT 0x101e76, BIT7
#define GPIO113_IN  0x101e70, BIT7

#define GPIO114_PAD PAD_PCM_A10
#define GPIO114_OEN 0x101e7c, BIT6
#define GPIO114_OUT 0x101e76, BIT6
#define GPIO114_IN  0x101e70, BIT6

#define GPIO115_PAD PAD_PCM_CE_N
#define GPIO115_OEN 0x101e7c, BIT5
#define GPIO115_OUT 0x101e76, BIT5
#define GPIO115_IN  0x101e70, BIT5

#define GPIO116_PAD PAD_PCM_D7
#define GPIO116_OEN 0x101e7c, BIT4
#define GPIO116_OUT 0x101e76, BIT4
#define GPIO116_IN  0x101e70, BIT4

#define GPIO117_PAD PAD_PCM_D6
#define GPIO117_OEN 0x101e7c, BIT3
#define GPIO117_OUT 0x101e76, BIT3
#define GPIO117_IN  0x101e70, BIT3

#define GPIO118_PAD PAD_PCM_D5
#define GPIO118_OEN 0x101e7c, BIT2
#define GPIO118_OUT 0x101e76, BIT2
#define GPIO118_IN  0x101e70, BIT2

#define GPIO119_PAD PAD_PCM_D4
#define GPIO119_OEN 0x101e7c, BIT1
#define GPIO119_OUT 0x101e76, BIT1
#define GPIO119_IN  0x101e70, BIT1
...
#define GPIO136_PAD PAD_NAND_CLE
#define GPIO136_OEN 0x101e88, BIT2
#define GPIO136_OUT 0x101e89, BIT2
#define GPIO136_IN  0x101e90, BIT2

#define GPIO137_PAD PAD_NAND_CEZ
#define GPIO137_OEN 0x101e88, BIT0
#define GPIO137_OUT 0x101e89, BIT0
#define GPIO137_IN  0x101e90, BIT0

#define GPIO138_PAD PAD_NAND_CEZ1
#define GPIO138_OEN 0x101e88, BIT1
#define GPIO138_OUT 0x101e89, BIT1
#define GPIO138_IN  0x101e90, BIT1

#define GPIO139_PAD PAD_NAND_REZ
#define GPIO139_OEN 0x101e88, BIT3
#define GPIO139_OUT 0x101e89, BIT3
#define GPIO139_IN  0x101e90, BIT3

#define GPIO140_PAD PAD_NAND_WEZ
#define GPIO140_OEN 0x101e88, BIT4
#define GPIO140_OUT 0x101e89, BIT4
#define GPIO140_IN  0x101e90, BIT4

#define GPIO141_PAD PAD_NAND_ALE
#define GPIO141_OEN 0x101e88, BIT6
#define GPIO141_OUT 0x101e89, BIT6
#define GPIO141_IN  0x101e90, BIT6

#define GPIO142_PAD PAD_NAND_RBZ
#define GPIO142_OEN 0x101e88, BIT7
#define GPIO142_OUT 0x101e89, BIT7
#define GPIO142_IN  0x101e90, BIT7

#define GPIO143_PAD PAD_TCON6
#define GPIO143_OEN 0x1032ff, BIT5
#define GPIO143_OUT 0x1032f5, BIT3
#define GPIO143_IN  0x1032fe, BIT7

#define GPIO144_PAD PAD_TCON7
#define GPIO144_OEN 0x1032ff, BIT3
#define GPIO144_OUT 0x1032f5, BIT1
#define GPIO144_IN  0x1032fe, BIT5

#define GPIO145_PAD PAD_TCON8
#define GPIO145_OEN 0x1032ff, BIT4
#define GPIO145_OUT 0x1032f5, BIT2
#define GPIO145_IN  0x1032fe, BIT6

#define GPIO146_PAD PAD_TCON16
#define GPIO146_OEN 0x1032ff, BIT2
#define GPIO146_OUT 0x1032f5, BIT0
#define GPIO146_IN  0x1032fe, BIT4

#define GPIO147_PAD PAD_TCON18
#define GPIO147_OEN 0x1032ff, BIT7
#define GPIO147_OUT 0x1032f5, BIT5
#define GPIO147_IN  0x1032fe, BIT1

#define GPIO148_PAD PAD_TCON19
#define GPIO148_OEN 0x1032ff, BIT6
#define GPIO148_OUT 0x1032f5, BIT4
#define GPIO148_IN  0x1032fe, BIT0

#define GPIO149_PAD PAD_I2S_IN_WS
#define GPIO149_OEN 0x101e6E, BIT0
#define GPIO149_OUT 0x101e6C, BIT0
#define GPIO149_IN  0x101e6A, BIT0

#define GPIO150_PAD PAD_I2S_IN_BCK
#define GPIO150_OEN 0x101e6E, BIT1
#define GPIO150_OUT 0x101e6C, BIT1
#define GPIO150_IN  0x101e6A, BIT1

#define GPIO151_PAD PAD_I2S_IN_SD
#define GPIO151_OEN 0x101e6E, BIT2
#define GPIO151_OUT 0x101e6C, BIT2
#define GPIO151_IN  0x101e6A, BIT2

#define GPIO152_PAD PAD_SPDIF_IN
#define GPIO152_OEN 0x101e6E, BIT3
#define GPIO152_OUT 0x101e6C, BIT3
#define GPIO152_IN  0x101e6A, BIT3

#define GPIO153_PAD PAD_SPDIF_OUT
#define GPIO153_OEN 0x101e6E, BIT4
#define GPIO153_OUT 0x101e6C, BIT4
#define GPIO153_IN  0x101e6A, BIT4

#define GPIO154_PAD PAD_I2S_OUT_MCK
#define GPIO154_OEN 0x101e6E, BIT6
#define GPIO154_OUT 0x101e6C, BIT6
#define GPIO154_IN  0x101e6A, BIT6

#define GPIO155_PAD PAD_I2S_OUT_WS
#define GPIO155_OEN 0x101e6E, BIT5
#define GPIO155_OUT 0x101e6C, BIT5
#define GPIO155_IN  0x101e6A, BIT5

#define GPIO156_PAD PAD_I2S_OUT_BCK
#define GPIO156_OEN 0x101e6E, BIT7
#define GPIO156_OUT 0x101e6C, BIT7
#define GPIO156_IN  0x101e6A, BIT7

#define GPIO157_PAD PAD_I2S_OUT_SD
#define GPIO157_OEN 0x101e6F, BIT0
#define GPIO157_OUT 0x101e6D, BIT0
#define GPIO157_IN  0x101e6B, BIT0

#define GPIO158_PAD PAD_I2S_OUT_SD1
#define GPIO158_OEN 0x101e6F, BIT1
#define GPIO158_OUT 0x101e6D, BIT1
#define GPIO158_IN  0x101e6B, BIT1

#define GPIO159_PAD PAD_I2S_OUT_SD2
#define GPIO159_OEN 0x101e6F, BIT2
#define GPIO159_OUT 0x101e6D, BIT2
#define GPIO159_IN  0x101e6B, BIT2

#define GPIO160_PAD PAD_I2S_OUT_SD3
#define GPIO160_OEN 0x101e6F, BIT3
#define GPIO160_OUT 0x101e6D, BIT3
#define GPIO160_IN  0x101e6B, BIT3

#define GPIO161_PAD PAD_B_ODD0
#define GPIO161_OEN 0x1032fc, BIT3
#define GPIO161_OUT 0x1032fc, BIT7
#define GPIO161_IN  0x1032fe, BIT3

#define GPIO162_PAD PAD_B_ODD1
#define GPIO162_OEN 0x1032fc, BIT2
#define GPIO162_OUT 0x1032fc, BIT6
#define GPIO162_IN  0x1032fe, BIT2

#define GPIO163_PAD PAD_B_ODD2
#define GPIO163_OEN 0x1032fc, BIT1
#define GPIO163_OUT 0x1032fc, BIT5
#define GPIO163_IN  0x1032fe, BIT1

#define GPIO164_PAD PAD_B_ODD3
#define GPIO164_OEN 0x1032fc, BIT0
#define GPIO164_OUT 0x1032fc, BIT4
#define GPIO164_IN  0x1032fe, BIT0

#define GPIO165_PAD PAD_B_ODD4
#define GPIO165_OEN 0x1032a5, BIT7
#define GPIO165_OUT 0x1032a1, BIT7
#define GPIO165_IN  0x1032ad, BIT7

#define GPIO166_PAD PAD_B_ODD5
#define GPIO166_OEN 0x1032a5, BIT6
#define GPIO166_OUT 0x1032a1, BIT6
#define GPIO166_IN  0x1032ad, BIT6

#define GPIO167_PAD PAD_B_ODD6
#define GPIO167_OEN 0x1032a5, BIT5
#define GPIO167_OUT 0x1032a1, BIT5
#define GPIO167_IN  0x1032ad, BIT5

#define GPIO168_PAD PAD_B_ODD7
#define GPIO168_OEN 0x1032a5, BIT4
#define GPIO168_OUT 0x1032a1, BIT4
#define GPIO168_IN  0x1032ad, BIT4

#define GPIO169_PAD PAD_G_ODD0
#define GPIO169_OEN 0x1032a5, BIT3
#define GPIO169_OUT 0x1032a1, BIT3
#define GPIO169_IN  0x1032ad, BIT3

#define GPIO170_PAD PAD_G_ODD1
#define GPIO170_OEN 0x1032a5, BIT2
#define GPIO170_OUT 0x1032a1, BIT2
#define GPIO170_IN  0x1032ad, BIT2

#define GPIO171_PAD PAD_G_ODD2
#define GPIO171_OEN 0x1032a5, BIT1
#define GPIO171_OUT 0x1032a1, BIT1
#define GPIO171_IN  0x1032ad, BIT1

#define GPIO172_PAD PAD_G_ODD3
#define GPIO172_OEN 0x1032a5, BIT0
#define GPIO172_OUT 0x1032a1, BIT0
#define GPIO172_IN  0x1032ad, BIT0

#define GPIO173_PAD PAD_G_ODD4
#define GPIO173_OEN 0x1032a4, BIT7
#define GPIO173_OUT 0x1032a0, BIT7
#define GPIO173_IN  0x1032ac, BIT7

#define GPIO174_PAD PAD_G_ODD5
#define GPIO174_OEN 0x1032a4, BIT6
#define GPIO174_OUT 0x1032a0, BIT6
#define GPIO174_IN  0x1032ac, BIT6

#define GPIO175_PAD PAD_G_ODD6
#define GPIO175_OEN 0x1032a4, BIT5
#define GPIO175_OUT 0x1032a0, BIT5
#define GPIO175_IN  0x1032ac, BIT5

#define GPIO176_PAD PAD_G_ODD7
#define GPIO176_OEN 0x1032a4, BIT4
#define GPIO176_OUT 0x1032a0, BIT4
#define GPIO176_IN  0x1032ac, BIT4

#define GPIO177_PAD PAD_R_ODD0
#define GPIO177_OEN 0x1032a4, BIT3
#define GPIO177_OUT 0x1032a0, BIT3
#define GPIO177_IN  0x1032ac, BIT3

#define GPIO178_PAD PAD_R_ODD1
#define GPIO178_OEN 0x1032a4, BIT2
#define GPIO178_OUT 0x1032a0, BIT2
#define GPIO178_IN  0x1032ac, BIT2

#define GPIO179_PAD PAD_R_ODD2
#define GPIO179_OEN 0x1032a4, BIT1
#define GPIO179_OUT 0x1032a0, BIT1
#define GPIO179_IN  0x1032ac, BIT1

#define GPIO180_PAD PAD_R_ODD3
#define GPIO180_OEN 0x1032a4, BIT0
#define GPIO180_OUT 0x1032a0, BIT0
#define GPIO180_IN  0x1032ac, BIT0

#define GPIO181_PAD PAD_R_ODD4
#define GPIO181_OEN 0x1032a3, BIT7
#define GPIO181_OUT 0x10329f, BIT7
#define GPIO181_IN  0x1032ab, BIT7

#define GPIO182_PAD PAD_R_ODD5
#define GPIO182_OEN 0x1032a3, BIT6
#define GPIO182_OUT 0x10329f, BIT6
#define GPIO182_IN  0x1032ab, BIT6

#define GPIO183_PAD PAD_R_ODD6
#define GPIO183_OEN 0x1032a3, BIT5
#define GPIO183_OUT 0x10329f, BIT5
#define GPIO183_IN  0x1032ab, BIT5

#define GPIO184_PAD PAD_R_ODD7
#define GPIO184_OEN 0x1032a3, BIT4
#define GPIO184_OUT 0x10329f, BIT4
#define GPIO184_IN  0x1032ab, BIT4

#define GPIO185_PAD PAD_mini_LVDS0
#define GPIO185_OEN 0x1032a3, BIT3
#define GPIO185_OUT 0x10329f, BIT3
#define GPIO185_IN  0x1032ab, BIT3

#define GPIO186_PAD PAD_mini_LVDS1
#define GPIO186_OEN 0x1032a3, BIT2
#define GPIO186_OUT 0x10329f, BIT2
#define GPIO186_IN  0x1032ab, BIT2

#define GPIO187_PAD PAD_mini_LVDS2
#define GPIO187_OEN 0x1032a3, BIT1
#define GPIO187_OUT 0x10329f, BIT1
#define GPIO187_IN  0x1032ab, BIT1

#define GPIO188_PAD PAD_mini_LVDS3
#define GPIO188_OEN 0x1032a3, BIT0
#define GPIO188_OUT 0x10329f, BIT0
#define GPIO188_IN  0x1032ab, BIT0

#define GPIO189_PAD PAD_mini_LVDS4
#define GPIO189_OEN 0x1032a2, BIT7
#define GPIO189_OUT 0x10329e, BIT7
#define GPIO189_IN  0x1032aa, BIT7

#define GPIO190_PAD PAD_mini_LVDS5
#define GPIO190_OEN 0x1032a2, BIT6
#define GPIO190_OUT 0x10329e, BIT6
#define GPIO190_IN  0x1032aa, BIT6

#define GPIO191_PAD PAD_mini_LVDS6
#define GPIO191_OEN 0x1032a2, BIT5
#define GPIO191_OUT 0x10329e, BIT5
#define GPIO191_IN  0x1032aa, BIT5

#define GPIO192_PAD PAD_mini_LVDS7
#define GPIO192_OEN 0x1032a2, BIT4
#define GPIO192_OUT 0x10329e, BIT4
#define GPIO192_IN  0x1032aa, BIT4

#define GPIO193_PAD PAD_LCK
#define GPIO193_OEN 0x1032a2, BIT3
#define GPIO193_OUT 0x10329e, BIT3
#define GPIO193_IN  0x1032aa, BIT3

#define GPIO194_PAD PAD_LDE
#define GPIO194_OEN 0x1032a2, BIT2
#define GPIO194_OUT 0x10329e, BIT2
#define GPIO194_IN  0x1032aa, BIT2

#define GPIO195_PAD PAD_LHSYNC
#define GPIO195_OEN 0x1032a2, BIT1
#define GPIO195_OUT 0x10329e, BIT1
#define GPIO195_IN  0x1032aa, BIT1

#define GPIO196_PAD PAD_LVSYNC
#define GPIO196_OEN 0x1032a2, BIT0
#define GPIO196_OUT 0x10329e, BIT0
#define GPIO196_IN  0x1032aa, BIT0

#define GPIO197_PAD PAD_PCM_WE_N
#define GPIO197_OEN 0x101e7d, BIT7
#define GPIO197_OUT 0x101e77, BIT7
#define GPIO197_IN  0x101e71, BIT7

#define GPIO198_PAD PAD_NAND_WPZ
#define GPIO198_OEN 0x101e88, BIT5
#define GPIO198_OUT 0x101e89, BIT5
#define GPIO198_IN  0x101e90, BIT5

#define GPIO199_PAD PAD_PWM_PM
#define GPIO199_OEN 0x0e3c, BIT1
#define GPIO199_OUT 0x0e3a, BIT1
#define GPIO199_IN  0x0e3b, BIT1

#define GPIO200_PAD PAD_AV_LNK
#define GPIO200_OEN 0x0e3c, BIT3
#define GPIO200_OUT 0x0e3a, BIT3
#define GPIO200_IN  0x0e3b, BIT3

#define GPIO201_PAD PAD_SPI1_CK
#define GPIO201_OEN 0x101e90, BIT0
#define GPIO201_OUT 0x101e90, BIT4
#define GPIO201_IN  0x101e91, BIT0

#define GPIO202_PAD PAD_SPI1_DI
#define GPIO202_OEN 0x101e90, BIT1
#define GPIO202_OUT 0x101e90, BIT5
#define GPIO202_IN  0x101e91, BIT1

#define GPIO203_PAD PAD_SPI2_CK
#define GPIO203_OEN 0x101e90, BIT2
#define GPIO203_OUT 0x101e90, BIT6
#define GPIO203_IN  0x101e91, BIT2

#define GPIO204_PAD PAD_SPI2_DI
#define GPIO204_OEN 0x101e90, BIT3
#define GPIO204_OUT 0x101e90, BIT7
#define GPIO204_IN  0x101e91, BIT3
