...
#define GPIO22_IN  0x0e4f, BIT0
#elif (T3_VERSION == T3_U02)
#define GPIO19_PAD PAD_HOTPLUGA
#define GPIO19_OEN 0x0e4e, BIT0
#define GPIO19_OUT 0x0e4e, BIT4
...
//
    ...
    __GPIO(220), __GPIO(221), __GPIO(222), 
