...
void MHal_EMAC_Power_On_Clk( void )
{
    ...
    *( ( u32 * ) ( ( char * ) 0xFD243200 +  0x6F*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xFD243200 +  0x6F*4) ) & 0xFF00) | 0x0059 );
    *( ( u32 * ) ( ( char * ) 0xFD243200 +  0x7A*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xFD243200 +  0x7A*4) ) & 0xFF00) | 0x0021 );
    *( ( u32 * ) ( ( char * ) 0xFD243000 +  0x39*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xFD243000 +  0x39*4) ) & 0xFF00) | 0x0080 );
    *( ( u32 * ) ( ( char * ) 0xFD243200 +  0x5B*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xFD243200 +  0x5B*4) ) & 0x00FF) | 0x0700 );
    *( ( u32 * ) ( ( char * ) 0xFD243200 +  0x65*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xFD243200 +  0x65*4) ) & 0x00FF) | 0x1100 );
    *( ( u32 * ) ( ( char * ) 0xFD243200 +  0x66*4) ) = 0xD180;
    *( ( u32 * ) ( ( char * ) 0xFD243200 +  0x6A*4) ) = (*( ( u32 * ) ( ( char * ) 0xFD243200 +  0x6A*4) ) & 0xFF00);
    *( ( u32 * ) ( ( char * ) 0xFD243200 +  0x5C*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xFD243200 +  0x5C*4) ) & 0x00FF) | 0x4000 );
    *( ( u32 * ) ( ( char * ) 0xFD243200 +  0x5D*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xFD243200 +  0x5D*4) ) & 0x00FF) | 0x0500 );
    *( ( u32 * ) ( ( char * ) 0xFD243200 +  0x58*4) ) = 0x6002;
    //*( ( u32 * ) ( ( char * ) 0xBF203C00 +  0x5A*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xBF203C00 +  0x5A*4) ) & 0xFF00) | 0x0010 );
    *( ( u32 * ) ( ( char * ) 0xFD243000 +  0x39*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xFD243000 +  0x39*4) ) & 0xFFF7)); //unset loop_back_enable
    *( ( u32 * ) ( ( char * ) 0xFD243200 +  0x5A*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xFD243200 +  0x5A*4) ) & 0xFF00) | 0x0056 ); //gain shift
    *( ( u32 * ) ( ( char * ) 0xFD243200 +  0x27*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xFD243200 +  0x27*4) ) & 0x00FF) | 0x0200 ); //det max
    *( ( u32 * ) ( ( char * ) 0xFD243200 +  0x28*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xFD243200 +  0x28*4) ) & 0x00FF) | 0x0100 ); //det min
    *( ( u32 * ) ( ( char * ) 0xFD243200 +  0x3B*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xFD243200 +  0x3B*4) ) & 0x00FF) | 0x1800); //snr len (emc noise)
    *( ( u32 * ) ( ( char * ) 0xFD243200 +  0x21*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xFD243200 +  0x21*4) ) & 0x00FF) | 0x1500); //snr k value
    // Set MII Mode
