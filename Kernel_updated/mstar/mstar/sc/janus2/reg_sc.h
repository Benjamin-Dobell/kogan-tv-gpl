...
//  Macro and Define
//-------------------------------------------------------------------------------------------------
#define SC_REGBASE1                 0xBF246600
#define SC_REGBASE2                 0xBF246680
...
#define REG_TOP_SM0                 (0x0F00+0x0C)
    #define TOP_SM0_OPEN                            BITS(1:0,1)
    #define TOP_OCP0_EN                             BITS(3:2,1)
    #define TOP_SM0_C48                             BITS(5:4,1)
    #define TOP_SM0_EN                              BITS(7:6,1)

#define REG_TOP_SM1                 (0x0F00+0x0C)
    #define TOP_SM1_OPEN                            BITS(9:8,1)
    #define TOP_OCP1_EN                             BITS(11:10,1)
    #define TOP_SM1_C48                             BITS(13:12,1)
    #define TOP_SM1_EN                              BITS(15:14,1)
#if 0
...
#endif
#define REG_TOP_CKG_UART_CLK        (0x0580+0x17)
    #define TOP_CKG_UART1_MASK                      BMASK(4:0)
    #define TOP_CKG_UART1_CLK_DIS                   BIT(0)
    #define TOP_CKG_UART1_CLK_INV                   BIT(1)
    #define TOP_CKG_UART1_CLK_MASK                  BMASK(4:2)
