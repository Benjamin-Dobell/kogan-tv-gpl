...
#define GPIO79_OEN 0x102b87, BIT1
#define GPIO79_OUT 0x102b87, BIT0
#define GPIO79_IN  0x102b87, BIT2

#define GPIO80_PAD PAD_DDCR_CK
#define GPIO80_OEN 0x102b86, BIT1
#define GPIO80_OUT 0x102b86, BIT0
#define GPIO80_IN  0x102b86, BIT2
...
#define GPIO157_PAD PAD_EMMC_CDZ
...
#define GPIO184_PAD PAD_DDCA_CK
#define GPIO184_OEN 0x000494, BIT1
#define GPIO184_OUT 0x000494, BIT2
#define GPIO184_IN  0x000494, BIT0

#define GPIO185_PAD PAD_DDCA_DA
#define GPIO185_OEN 0x000494, BIT5
#define GPIO185_OUT 0x000494, BIT6
#define GPIO185_IN  0x000494, BIT4
...
//  Macro and Define
//-------------------------------------------------------------------------------------------------
#if defined (PRJ_X5) || defined(PRJ_X9) || defined(PRJ_X10)
