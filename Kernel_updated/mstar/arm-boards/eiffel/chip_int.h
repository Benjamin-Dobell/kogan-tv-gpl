...
//  E_FIQEXPL_RESERVED          = E_FIQEXPL_START + 3,
    ...
    E_FIQEXPL_ARM_TO_SECURER2   = E_FIQEXPL_START + 9,
    ...
    #define IRQ_SC                              (0x1 << (E_IRQ_SC               - E_IRQL_START) )
    ...
    #define FIQEXPH_SECURER2_TO_ARMC1           (0x1 << (E_FIQEXPH_UHC2          - E_FIQEXPH_START) )
    #define FIQEXPH_SECURER2_TO_ARM             (0x1 << (E_FIQEXPH_GPIO3         - E_FIQEXPH_START) )
    #define FIQEXPH_SECURER2_TO_8051            (0x1 << (E_FIQEXPH_GPIO4         - E_FIQEXPH_START) )
    #define FIQEXPH_USB1                        (0x1 << (E_FIQEXPH_GPIO5         - E_FIQEXPH_START) )
    #define FIQEXPH_UHC1                        (0x1 << (E_FIQEXPH_GPIO6         - E_FIQEXPH_START) )
    #define FIQEXPH_USB2                        (0x1 << (E_FIQEXPH_PWM_RP_I      - E_FIQEXPH_START) )
