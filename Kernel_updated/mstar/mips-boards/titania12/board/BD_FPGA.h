...
#if defined(CONFIG_MSTAR_TITANIA8_MMAP_128MB_128MB) || defined(CONFIG_MSTAR_TITANIA12_MMAP_128MB_128MB)
#include "mmap/mmap_128mb_128mb.h"
#elif defined(CONFIG_MSTAR_TITANIA8_MMAP_256MB_256MB) || defined(CONFIG_MSTAR_TITANIA12_MMAP_256MB_256MB)
#include "mmap/mmap_256mb_256mb.h"
#elif defined(CONFIG_MSTAR_TITANIA8_MMAP_512MB_512MB) || defined(CONFIG_MSTAR_TITANIA12_MMAP_512MB_512MB)
#include "mmap/mmap_512mb_512mb.h"
#elif defined(CONFIG_MSTAR_TITANIA8_MMAP_128MB) || defined(CONFIG_MSTAR_TITANIA12_MMAP_128MB)
