...
void __init prom_meminit(void)
{
    ...
    #if defined(CONFIG_MSTAR_TITANIA8) || defined(CONFIG_MSTAR_JANUS2) || defined(CONFIG_MSTAR_TITANIA11) || defined(CONFIG_MSTAR_TITANIA12) || defined(CONFIG_MSTAR_KRONUS) || defined(CONFIG_MSTAR_KAISERIN) || \
