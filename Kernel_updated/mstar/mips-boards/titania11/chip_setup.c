...
#if defined(CONFIG_MSTAR_TITANIA11_BD_GENERIC)
#define MSTAR_CHIP_UART_CLK_FREQ                123000000
#endif
...
#if defined(CONFIG_MSTAR_TITANIA11_MMAP_128MB_128MB)
    // for MIU assignment
...
#ifdef CONFIG_MSTAR_TITANIA11_BD_FPGA
    ...
    if( !CacheLineSize )
    {
        ...
        switch(CacheLineSize  )
        {
         ...
         case 3:
            ...
            break;
        default:
            printk("Chip_L2_cache_wback_inv Failed: Unknown cache line size:%x \n"  , CacheLineSize);
            return;
            break;
        }
    }
    ...
    if( !CacheLineSize )
    {
        ...
        switch(CacheLineSize  )
        {
         ...
         case 3:
            ...
            break;
        default:
            printk("Chip_L2_cache_wback Failed: Unknown cache line size:%x \n"  , CacheLineSize);
            return;
            break;
        }
    }
...
#endif
*(volatile unsigned int *)(0xbf000000+0x20258C) =  0x5; // H41 all
...
//    _chip_flush_miu_pipe();
    ...
    {
	volatile unsigned int temp=0;
        *(volatile unsigned int*)(0xbf000000+0x203104) &= ~(BMASK(3:0)) ;  // H41
        *(volatile unsigned int*)(0xbf000000+0x203104) |= 0x02 ;  // H41
	*(volatile unsigned int *)(0xbf000000+0x203104) |= _BIT(4); // H41
        *(volatile unsigned int *)(0xbf000000+0x203104) &= ~(_BIT(4)); // H41
        *(volatile unsigned int*)(0xbf000000+0x203104) &= ~(BMASK(3:0)) ;  // H41
	do
	...
	pu8 =(volatile unsigned char*)(0xa0000000+0x4000000-64); //64M-64bytes
#else
	pu8 =(volatile unsigned char*)(MIPS_MIU1_BASE+(BB_ADR-MIU_INTERVAL));
#endif
