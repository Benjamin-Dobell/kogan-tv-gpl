...
#if defined(CONFIG_MSTAR_TITANIA13_MMAP_32MB_32MB) || \
    defined(CONFIG_MSTAR_TITANIA13_MMAP_64MB_32MB) || \
    defined(CONFIG_MSTAR_TITANIA13_MMAP_64MB_64MB) || \
    defined(CONFIG_MSTAR_TITANIA13_MMAP_128MB_64MB) || \
    defined(CONFIG_MSTAR_MMAP_128MB_128MB_DEFAULT) || \
    defined(CONFIG_MSTAR_TITANIA13_MMAP_128MB_128MB) || \
	defined(CONFIG_MSTAR_TITANIA13_MMAP_256MB_256MB)
...
#ifdef CONFIG_MSTAR_TITANIA13_BD_FPGA
...
{
#if defined(CONFIG_MSTAR_TITANIA8) || defined(CONFIG_MSTAR_TITANIA9) || defined(CONFIG_MSTAR_TITANIA13)
    volatile unsigned int temp=0;
