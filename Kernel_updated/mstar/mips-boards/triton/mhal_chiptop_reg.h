...
#define REG_TOP_SVD_MVD                 0x0014
    #define TOP_CKG_SVD_MASK                    BMASK(6:0)
    #define TOP_CKG_SVD_DIS                     BIT(0)
    #define TOP_CKG_SVD_INV                     BIT(1)
    #define TOP_CKG_SVD_SRC_240                 BITS(6:2, 0)
    #define TOP_CKG_SVD_SRC_216                 BITS(6:2, 1)
    #define TOP_CKG_SVD_SRC_144                 BITS(6:2, 2)
    #define TOP_CKG_SVD_SRC_123                 BITS(6:2, 3)
    #define TOP_CKG_SVD_SRC_108                 BITS(6:2, 4)
    #define TOP_CKG_SVD_SRC_72                  BITS(6:2, 5)
    #define TOP_CKG_SVD_SRC_96                  BITS(6:2, 7)
    #define TOP_CKG_SVD_SRC_MIU                 BITS(6:2, 10)
    #define TOP_CKG_SVD_SRC_XTAL                BITS(6:2, 18)
    #define TOP_CKG_MVD_IAP_RMEM_MASK           BMASK(10:8)
    #define TOP_CKG_MVD_IAP_RMEM_DIS            BIT(8)
    #define TOP_CKG_MVD_IAP_RMEM_INV            BIT(9)
    #define TOP_CKG_MVD_IAP_RMEM_SRC_XTAL       BIT(10)
    #define TOP_CKG_MVD_MASK                    BMASK(15:11)
    #define TOP_CKG_MVD_DIS                     BIT(12)
    #define TOP_CKG_MVD_INV                     BIT(13)
    #define TOP_CKG_MVD_SRC_144                 BITS(15:14, 0)
    #define TOP_CKG_MVD_SRC_123                 BITS(15:14, 1)
    #define TOP_CKG_MVD_SRC_SVD                 BITS(15:14, 3)
    #define TOP_CKG_MVD_SRC_MIU                 BITS(15:14, 1)
    #define TOP_CKG_MVD_SRC_XTAL                BITS(15:14, 3)
