...
typedef enum
{
    ...
    E_IRQ_8051_LITE         = E_IRQL_START+12,
    E_IRQ_SBM               = E_IRQL_START+13,
    E_IRQ_SVD               = E_IRQL_START+14,
    ...
    E_IRQ_MLINK             = E_IRQH_START+11,
    //E_IRQ_VBI               = E_IRQH_START+12,
    E_IRQ_MVD               = E_IRQH_START+12,
...
#define IRQL_VBI                    (0x1 << (E_IRQ_VBI   - E_IRQL_START))
...
#define IRQL_EMAC                   (0x1 << (E_IRQ_EMAC  - E_IRQL_START))
#define IRQL_SVD                    (0x1 << (E_IRQ_SVD - E_IRQL_START))
#define IRQL_8051_LITE              (0x1 << (E_IRQ_8051_LITE - E_IRQL_START))
...
#define IRQH_MVD                    (0x1 << (E_IRQ_MVD      - E_IRQH_START)   )
