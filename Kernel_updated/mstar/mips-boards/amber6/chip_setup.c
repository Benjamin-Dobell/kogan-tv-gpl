...
#if defined(CONFIG_MSTAR_AMBER6_BD_FPGA)
...
#if (defined(CONFIG_MSTAR_TITANIA9_BD_FPGA) || defined(CONFIG_MSTAR_TITANIA13_BD_FPGA) || defined(CONFIG_MSTAR_AMBER6_BD_FPGA))
