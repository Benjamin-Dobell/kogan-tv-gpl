...
const char display_string[] = "        LINUX ON Titania10     ";
...
{
	return "MStar Titania10";
}

static int __init Titania10_setup(void)
{
       // int i;

	printk("Begin Titania10_setup\n");
...
#ifdef CONFIG_MSTAR_TITANIA10_BD_FPGA
