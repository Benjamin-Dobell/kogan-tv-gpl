...
#if 1 // For MStar debug through DDCA

#define UART0_SRC_SEL               (UART_SEL_PIU)
#define UART1_SRC_SEL               (UART_SEL_HK51_UART1)
#define UART2_SRC_SEL               (UART_SEL_PM51_UART0)

#else	// For customer debug through phone jack (UART2)

#define UART0_SRC_SEL               (UART_SEL_PM51_UART0)
#define UART1_SRC_SEL               (UART_SEL_HK51_UART1)
...
#define BALL_G5_IS_GPIO             GPIO_IN         // EEPROM NVRAM SDA
#define BALL_H5_IS_GPIO             GPIO_IN         // EEPROM NVRAM SCL
#define BALL_F9_IS_GPIO             GPIO_OUT_HIGH   // VDDM_CTRL
#define BALL_D10_IS_GPIO            GPIO_OUT_HIGH   // SW PVCC
#define BALL_F5_IS_GPIO             GPIO_OUT_HIGH   // OP1
#define BALL_G6_IS_GPIO             GPIO_OUT_LOW    // MAIN EEPROM WP
#define BALL_H6_IS_GPIO             GPIO_OUT_LOW    // LED STB
#define BALL_AF11_IS_GPIO           GPIO_OUT_HIGH   // LAN_RESET

#define BALL_AC11_IS_GPIO           GPIO_IN         // TCON_WP
#define BALL_AC21_IS_GPIO           GPIO_OUT_HIGH   // AMP_RESET
#define BALL_AB21_IS_GPIO           GPIO_IN         // DET_5V
#define BALL_AF5_IS_GPIO            GPIO_OUT_LOW    // DDC_WP_SUB
#define BALL_AF10_IS_GPIO           GPIO_IN         // IDENT_PC
#define BALL_D6_IS_GPIO             GPIO_OUT_HIGH   // SW_INVERTER
#define BALL_D9_IS_GPIO             GPIO_IN         // POWER_DET
#define BALL_D7_IS_GPIO             GPIO_OUT_HIGH   // USB_EN
#define BALL_F10_IS_GPIO            GPIO_OUT_LOW    // RF_AGC_CTRL
#define BALL_C6_IS_GPIO             GPIO_OUT_LOW    // S_AMP_MUTE
...
#define VDDM_DELAY()    \
    do { volatile int i; for (i = 0; i < 0x1600; i++) ; } while (0)
