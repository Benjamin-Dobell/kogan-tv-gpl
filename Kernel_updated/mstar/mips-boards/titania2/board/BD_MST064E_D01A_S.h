...
#ifndef _BD_MST064E_D01A_S_H
#define _BD_MST064E_D01A_S_H

#define BOARD_NAME                  "BD_MST064E_D01A_S"
...
#define FRONTEND_DEMOD_TYPE             MSTAR_MSB1200_DEMOD
#define FRONTEND_TUNER_TYPE             MSTAR_TDTC_G001D_TUNER
...
#define PIN_FLASH_WP0               BALL_AC16
// #define PIN_FLASH_WP1               BALL_AA22

#define PIN_PF_WP0                  BALL_AB17

//------GPIO setting------------------------------------------------------------
#define BALL_E5_IS_GPIO             GPIO_IN         // USB_OCD_1
#define BALL_AC10_IS_GPIO           GPIO_IN         // USB_OCD_2
#define BALL_AC16_IS_GPIO           GPIO_OUT_LOW    // FLASH_WPN    Low - protect
#define BALL_AA22_IS_GPIO           GPIO_OUT_LOW    // FLASH_WPN_2
#define BALL_AA9_IS_GPIO            GPIO_OUT_HIGH   // AMP_STB      High: mute
...
//#define BALL_AA19_IS_GPIO           GPIO_OUT_HIGH   // MUTE_POP EAR-OUT FIXME

#define BALL_AA21_IS_GPIO           GPIO_OUT_LOW    //GPIO for Tuner AGC;; High=ATV Low=DTV
#define BALL_AB18_IS_GPIO           GPIO_OUT_LOW    //For SIF Control

// Audio Amplifier
#define Audio_Amplifier_ON()        MDrv_GPIO_Set_High(BALL_F9)
#define Audio_Amplifier_OFF()       MDrv_GPIO_Set_Low(BALL_F9)
...
#define AUDIO_SOURCE_SV             AUDIO_AUIN5_INPUT
...
#define AUDIO_PATH_SCART1           AUDIO_PATH_5 //for Line out
...
#define AUDIO_PATH_I2S              AUDIO_PATH_5
 ...
 #define AUDIO_OUTPUT_SCART1        AUDIO_I2S_OUTPUT
