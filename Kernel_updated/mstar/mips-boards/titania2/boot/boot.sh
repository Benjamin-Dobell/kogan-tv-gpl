...
if [ "$curBoardSet" != '' ] ; then
    ...
    printf "BD_MST064C_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST064D_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST064E_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST056C_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_S5_CUS03_DEMO_BOARD_1 = 0\n" >> $BOOT1_INC
    printf "BD_S6_CUS03_DEMO_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_CUS03_VBRD_BOARD_DVB_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_CUS03_MBRD_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_CUS03_MBRD_BOARD_DVB_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_CUS03_MIBRD_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
    printf '\n' >> $BOOT1_INC
fi
...
test -e "../../../../../.config" && curBoardSet=`grep -i CONFIG_MSTAR_TITANIA_BD_MST064C_D01A_S=y ../../../../../.config`
if [ "$curBoardSet" != '' ] ; then
	echo $curBoardSet
    printf "BD_MST055A_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST055B_D01A_S = 0\n" >> $BOOT1_INC
...
test -e "../../../../../.config" && curBoardSet=`grep -i CONFIG_MSTAR_TITANIA_BD_MST064D_D01A_S=y ../../../../../.config`
if [ "$curBoardSet" != '' ] ; then
	echo $curBoardSet
    printf "BD_MST055A_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST055B_D01A_S = 0\n" >> $BOOT1_INC
...
test -e "../../../../../.config" && curBoardSet=`grep -i CONFIG_MSTAR_TITANIA_BD_MST064E_D01A_S=y ../../../../../.config`
if [ "$curBoardSet" != '' ] ; then
	echo $curBoardSet
    printf "BD_MST055A_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST055B_D01A_S = 0\n" >> $BOOT1_INC
...
test -e "../../../../../.config" && curBoardSet=`grep -i CONFIG_MSTAR_TITANIA_BD_S5_CUS03_DEMO_BOARD_1=y ../../../../../.config`
if [ "$curBoardSet" != '' ] ; then
	echo $curBoardSet
    printf "BD_MST055A_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST055B_D01A_S = 0\n" >> $BOOT1_INC
    ...
    printf "BD_MST064E_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST056C_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_S5_CUS03_DEMO_BOARD_1 = 1\n" >> $BOOT1_INC
    printf "BD_S6_CUS03_DEMO_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
	printf "BD_T2_CUS03_VBRD_BOARD_DVB_1 = 0\n" >> $BOOT1_INC
	printf "BD_T2_CUS03_MBRD_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_CUS03_MBRD_BOARD_DVB_1 = 0\n" >> $BOOT1_INC
...
test -e "../../../../../.config" && curBoardSet=`grep -i CONFIG_MSTAR_TITANIA_BD_S6_CUS03_DEMO_BOARD_ATSC_1=y ../../../../../.config`
if [ "$curBoardSet" != '' ] ; then
	echo $curBoardSet
    printf "BD_MST055A_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST055B_D01A_S = 0\n" >> $BOOT1_INC
    ...
    printf "BD_MST056C_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_S5_CUS03_DEMO_BOARD_1 = 0\n" >> $BOOT1_INC
    printf "BD_S6_CUS03_DEMO_BOARD_ATSC_1 = 1\n" >> $BOOT1_INC
	printf "BD_T2_CUS03_VBRD_BOARD_DVB_1 = 0\n" >> $BOOT1_INC
	printf "BD_T2_CUS03_MBRD_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_CUS03_MBRD_BOARD_DVB_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_CUS03_MIBRD_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
...
test -e "../../../../../.config" && curBoardSet=`grep -i CONFIG_MSTAR_TITANIA_BD_T2_CUS03_VBRD_BOARD_DVB_1=y ../../../../../.config`
if [ "$curBoardSet" != '' ] ; then
	echo $curBoardSet
    printf "BD_MST055A_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST055B_D01A_S = 0\n" >> $BOOT1_INC
    ...
    printf "BD_S5_CUS03_DEMO_BOARD_1 = 0\n" >> $BOOT1_INC
    printf "BD_S6_CUS03_DEMO_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
	printf "BD_T2_CUS03_VBRD_BOARD_DVB_1 = 1\n" >> $BOOT1_INC
	printf "BD_T2_CUS03_MBRD_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_CUS03_MBRD_BOARD_DVB_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_CUS03_MIBRD_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
    printf '\n' >> $BOOT1_INC
...
test -e "../../../../../.config" && curBoardSet=`grep -i CONFIG_MSTAR_TITANIA_BD_T2_CUS03_MBRD_BOARD_ATSC_1=y ../../../../../.config`
if [ "$curBoardSet" != '' ] ; then
	echo $curBoardSet
    printf "BD_MST055A_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST055B_D01A_S = 0\n" >> $BOOT1_INC
    ...
    printf "BD_S6_CUS03_DEMO_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_CUS03_VBRD_BOARD_DVB_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_CUS03_MBRD_BOARD_ATSC_1 = 1\n" >> $BOOT1_INC
    printf "BD_T2_CUS03_MBRD_BOARD_DVB_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_CUS03_MIBRD_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
    printf '\n' >> $BOOT1_INC
fi

test -e "../../../../../.config" && curBoardSet=`grep -i CONFIG_MSTAR_TITANIA_BD_T2_CUS03_MBRD_BOARD_DVB_1=y ../../../../../.config`
if [ "$curBoardSet" != '' ] ; then
	echo $curBoardSet
    printf "BD_MST055A_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST055B_D01A_S = 0\n" >> $BOOT1_INC
    ...
    printf "BD_T2_CUS03_VBRD_BOARD_DVB_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_CUS03_MBRD_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_CUS03_MBRD_BOARD_DVB_1 = 1\n" >> $BOOT1_INC
    printf "BD_T2_CUS03_MIBRD_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
    printf '\n' >> $BOOT1_INC
fi

test -e "../../../../../.config" && curBoardSet=`grep -i CONFIG_MSTAR_TITANIA_BD_T2_CUS03_MIBRD_BOARD_ATSC_1=y ../../../../../.config`
if [ "$curBoardSet" != '' ] ; then
	echo $curBoardSet
    printf "BD_MST055A_D01A_S = 0\n" >> $BOOT1_INC
    printf "BD_MST055B_D01A_S = 0\n" >> $BOOT1_INC
    ...
    printf "BD_T2_CUS03_MBRD_BOARD_ATSC_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_CUS03_MBRD_BOARD_DVB_1 = 0\n" >> $BOOT1_INC
    printf "BD_T2_CUS03_MIBRD_BOARD_ATSC_1 = 1\n" >> $BOOT1_INC
    printf '\n' >> $BOOT1_INC
fi
