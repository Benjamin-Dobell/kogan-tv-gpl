...
#define REG_MB_8051_TO_AEON             (MAILBOX_REG_BASE + (E_MB_8051_TO_AEON << 1))
#define REG_MB_AEON_TO_8051             (MAILBOX_REG_BASE + (E_MB_AEON_TO_8051 << 1))
#define REG_MB_AEON_TO_MIPS             (MAILBOX_REG_BASE + (E_MB_AEON_TO_MIPS << 1))
#define REG_MB_MIPS_TO_AEON             (MAILBOX_REG_BASE + (E_MB_MIPS_TO_AEON << 1))
#define REG_MB_MIPS_TO_8051             (MAILBOX_REG_BASE + (E_MB_MIPS_TO_8051 << 1))
#define REG_MB_8051_TO_MIPS             (MAILBOX_REG_BASE + (E_MB_8051_TO_MIPS << 1))
